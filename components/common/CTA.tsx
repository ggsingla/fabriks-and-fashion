  ...
  return (
    <>
      <div className='overflow-hidden'>
        <div className='container xl:max-w-7xl mx-auto px-4 my-8 py-8 lg:px-8 lg:py-16 lg:my-16 relative bg-muted'>
          <div className='flex items-center flex-col md:flex-row relative space-y-8 md:space-y-0'>
            <div className='md:w-7/12 py-5 md:p-5 text-center md:text-left font-serif'>
              ...
              <h3 className='text-lg text-muted-foreground font-sans font-light leading-relaxed'>
